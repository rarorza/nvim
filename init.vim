...
set inccommand=split     " Multiple selection
set notimeout nottimeout " No timeout in leader key
...
set clipboard+=unnamedplus " Enable copy paste sync
...
" Reload init.vim in current session
